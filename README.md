...
<p style="color: #40AAD4; font-style: italic; border: 1px solid #40AAD4;font-size: 70%;">Popups de connexion</p>
...
<p style="color: #40AAD4; font-style: italic; border: 1px solid #40AAD4;font-size: 70%;">Informations utilisateur pour un expert</p>
...
<p style="color: #40AAD4; font-style: italic; border: 1px solid #40AAD4;font-size: 70%;">Système de messagerie pour un étudiant</p>
...
<p style="color: #40AAD4; font-style: italic; border: 1px solid #40AAD4;font-size: 70%;">Recherche d'un expert par spécialité</p>
...
<p style="color: #40AAD4; font-style: italic; border: 1px solid #40AAD4;font-size: 70%;">Architecture de la base de données</p>
